...
/**
 * 
 * @Title CMConstant.java
 * @Package com.sunyard.insurance.common
 * @Description
 * CM的常量类
 * @time 2012-8-9 下午04:24:19 @author xxw  @version 1.0 
 * -------------------------------------------------------
 */
public class CMConstant {
	...
	// --------------CM配置信息--------------------------------------------------------
	// CM用户名
	public static String CMUser = "";
	// CM密码
	public static String CMPwd = "";
	// ICMNLSDB
	public static String RMN = "";
	// CM初始化连接数
	public static int initPool = 0;
	// CM最小连接数
	public static int minPool = 0;
	// CM最大连接数
	public static int maxPool = 0;
	// -------------------------------------------------------------------------------
	public static String docName = "DOC_";// 文档项类型名

	public static String docBatchId = "BatchID";// 文档项类型默认属性，批次号

	public static String docBusiNo = "BUSI_NUM";// 文档项类型默认属性，业务编号

	public static String docInnerVer = "InnerVer";// 文档项类型默认属性，内部版本号

	public static String docBatchVer = "BatchVer";// 文档项类型默认属性，外部版本号

	public static String docPartName = "Source";// 文档部件项类型名

	public static String docPartSourceID = "SourceID";// 文档部件项类型默认属性，文件名【图片，syd文件】

	public static String docGdFlag = "GdFlag";//文档项类型默认属性，批次是否归档标志；0：未归档，1：已归档
	// ---------------------------------------------------------------------------------
	
	public static String queryCacheFolder = "";// 批次查询缓存路径

	public static int maxResultNum = 10;// CM查询最大条数
	// -------------------------------------------------------------------------------------
	public static int attrSubLen = 0;// 属性字段截取长度
	
	public static String isCMPool = "";// 是否使用CM连接POOL工具类

	public static int imageThreadNum = 0;// CM获取部件线程数
	
//	public static int queryCatchDay = 3;//cm查询缓存天数
